...
<%
	//Detail에서 넘어온 hidden 속성의 team, rank, depth를 현재 페이지 hidden에 넣어주자
...
<script>
	...
	$(function() {
		...
		$($("input[type='button']")[0]).click(function() {//답글등록
			$("form").attr({
				method : "post",
				action : "reply.jsp"
			});
...
<body>
	...
	<div class="container">
		<form>
			...
			<label for="fname">Writer</label> <input type="text" id="fname"
			...
			<input type="button" value="답글등록"> <input type="button"
				value="이전으로">
		</form>
	</div>
